...
bool write_data(map<string, Student*>& students, string& file_name)
{
    ...
    for ( auto [student_id, student_info] : students)
    {
        file_object << student_info-> student_number << ";"
                    << student_info-> user_id << ";"
                    <<student_info -> name << ";"
                    << student_info -> phone_number <<";"
                    << student_info -> email <<";"
                    << student_info -> skype <<endl;
    }
    return true;
}
